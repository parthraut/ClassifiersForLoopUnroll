...
/* input pcm for test */
// int pcm[LEN] = {1000, -1000, 1234, 3200, -1314, 0, 32767, -32768};
// int r_coded[LEN] = {250, 122, 230, 156, 97, 213, 170, 42};
// int r_decoded[LEN] = {1008, -1008, 1248, 3264, -1312, 8, 32256, -32256};
int pcm[LEN];
int r_coded[LEN];
int r_decoded[LEN];
 ...
 * @returns void
 */
void encode(int *out, int *in, int len)
{
    int alaw = 0;
    int pcm = 0;
    int sign = 0;
 ...
 * @returns void
 */
void decode(int *out, int *in, int len)
{
    int alaw = 0;
    int pcm = 0;
    int sign = 0;
